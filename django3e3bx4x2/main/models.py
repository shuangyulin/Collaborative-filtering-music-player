...
class yinlefenlei(BaseModel):
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    yinlefenlei=models.CharField ( max_length=255, null=True, unique=False, verbose_name='音乐分类' )
    '''
    yinlefenlei=VARCHAR
    '''
    class Meta:
        db_table = 'yinlefenlei'
        verbose_name = verbose_name_plural = '音乐分类'
class yinlexinxi(BaseModel):
    ...
    yinlefenlei=models.CharField ( max_length=255, null=True, unique=False, verbose_name='音乐分类' )
    yinlezhaopian=models.TextField   (  null=True, unique=False, verbose_name='音乐照片' )
    songfile=models.TextField   ( null=False, unique=False, verbose_name='音乐文件' )
    zuoquzhe=models.CharField ( max_length=255, null=True, unique=False, verbose_name='作曲者' )
    singer=models.CharField ( max_length=255,null=False, unique=False, verbose_name='歌手' )
    zuocizhe=models.CharField ( max_length=255, null=True, unique=False, verbose_name='作词者' )
    gequshizhang=models.CharField ( max_length=255, null=True, unique=False, verbose_name='歌曲时长' )
    faxingshijian=models.DateField   (  null=True, unique=False, verbose_name='发行时间' )
    lyric=models.TextField   (  null=True, unique=False, verbose_name='音乐歌词' )
...
class forum(BaseModel):
    ...
    class Meta:
        db_table = 'forum'
        verbose_name = verbose_name_plural = '音乐分享'
class forumtype(BaseModel):
    ...
    class Meta:
        db_table = 'forumtype'
        verbose_name = verbose_name_plural = '音乐分享类型'
class forumreport(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '音乐分享举报'
