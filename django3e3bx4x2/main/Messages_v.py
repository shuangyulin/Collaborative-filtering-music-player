...
def messages_query(request):
    ...
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        try:
            query_result = messages.objects.filter(**request.session.get("req_dict")).values()
...
def messages_save(request):
    ...
    后台新增
    '''
    request.funname = __name__+"."+messages_save.__name__
    request.operation = "新增留言反馈"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
        ...
        idOrErr= messages.createbyreq(messages,messages, req_dict)
...
def messages_add(request):
    ...
    前台新增
    '''
    request.funname = __name__+"."+messages_add.__name__
    request.operation = "新增留言反馈"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def messages_update(request):
    '''
    '''
    request.funname = __name__+"."+messages_update.__name__
    request.operation = "更新留言反馈"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def messages_delete(request):
    ...
    批量删除
    '''
    request.funname = __name__+"."+messages_delete.__name__
    request.operation = "删除留言反馈"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def messages_importExcel(request):
    request.funname = __name__+"."+messages_importExcel.__name__
    request.operation = "导入留言反馈"
    if request.method in ["POST", "GET"]:
